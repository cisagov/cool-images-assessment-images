...
issue](https://github.com/cisagov/cool-images-assessment-images/issues) in this
...
request](https://github.com/cisagov/cool-images-assessment-images/pulls), you
...
```console
cd cool-images-assessment-images
pyenv virtualenv <python_version_to_use> cool-images-assessment-images
pyenv local cool-images-assessment-images
